...
export class CreateJobTable1755014389791 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_372290d430122b510ba5d0a3d8" ON "job" ("posted_date") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_0115c5dfd644ea8d08433446fc" ON "job" ("external_id", "source") `,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0115c5dfd644ea8d08433446fc"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_372290d430122b510ba5d0a3d8"`,
    );
